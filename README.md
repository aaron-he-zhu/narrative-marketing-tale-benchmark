...
<!-- SYNC:BEGIN source=references/tale-benchmark.md umbrella=v17.0.0 — generated by scripts/sync-family.sh; edit the source, not this block -->
...
The framework is advisory. Executable profiles, item policies, context, and vetoes live in [`framework-catalog.json`](framework-catalog.json); shared scoring semantics live in [`scoring-semantics.md`](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/main/references/scoring-semantics.md).
